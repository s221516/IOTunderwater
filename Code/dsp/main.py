...
def logInCsv(id, bitrate, carrierfreq, original_message, decoded_message1, hamming_dist_without, decod_msg2, ham_dist_with, speaker_depth, distance_to_speaker, filename="pool_testing_cf14000_100_300bps, 200sd, 100ds.csv"):
