...
def compute_snr(signal_file, noise_file, bandpass_filter=None, plot_signals=False):
    ...
    if plot_signals:
        ...
        # Signal + Noise plot
        ax1.plot(time_signal, signal_plus_noise, 'b-', label='Signal + Noise', linewidth=1)
        ...
        # Noise only plot
        ax2.plot(time_noise, noise_only, 'r-', label='Noise Only', linewidth=1)
...
if __name__ == "__main__":
    ...
    snr = compute_snr(signal_path, noise_path, bandpass_filter=(5000, 7000), plot_signals=True)
