...
modulation_signal = (0.2 + 0.85 * modulation_signal)  # Adjust amplitude between 0.3 (low) and 1 (high)
...
modulated_wave = (modulated_wave * 32767).astype(np.int16)  # Convert to 16-bit PCM format
